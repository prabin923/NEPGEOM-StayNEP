        ...
        <div className="flex h-16 items-center justify-between lg:h-20">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <button
              ...
              className="relative rounded-[36px] bg-obsidian px-5 py-2.5 text-sm font-medium text-snow shadow-button transition-transform duration-200 active:scale-95 cursor-pointer"
            >
              Get Started
            </button>
          </div>
      ...
      >
        ...
        >
          <div className="flex flex-col gap-1 p-4">
            ...
            <button
              onClick={() => scrollTo('map')}
              className="rounded-[36px] bg-obsidian px-4 py-3 text-center text-base font-medium text-snow shadow-button cursor-pointer"
            >
              Get Started
            </button>
          </div>
